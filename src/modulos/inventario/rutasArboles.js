...
router.get('/obtener-subParcela-arboles/:id/:Parc', controladorArboles.obtenerSubParcelaArbol)
...
router.get('/obtener-cantidad-arboles', controladorArboles.obtenerCantidadArboles)
